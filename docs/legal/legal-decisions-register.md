...
### Conservación mínima de una solicitud cancelada
...
Durante ese período, la conservación se limitará a los datos mínimos necesarios para comprobar la cancelación, gestionar fallos inmediatos y evitar inconsistencias.

### Datos mínimos permitidos

La solicitud cancelada podrá conservar temporalmente:
...
- La expiración no deberá afectar la cuenta activa ni sus datos ordinarios.
...
Los datos temporales utilizados para restaurar la configuración anterior del perfil deberán eliminarse inmediatamente después de completar y verificar la restauración.
...
- Un fallo de restauración deberá registrarse únicamente mediante un resultado técnico general y deberá corregirse mediante reintentos seguros.

### Nueva solicitud de eliminación

La existencia de una solicitud cancelada dentro de su período de conservación:
...
- No evitará que la nueva solicitud requiera una nueva verificación de identidad.
- No permitirá dos solicitudes activas simultáneamente para la misma cuenta.

Cada nueva solicitud tendrá su propio ciclo, estado, fechas y controles de seguridad.

### Estado de implementación

- Período de conservación aprobado: 30 días calendario desde `cancelledAt`.
