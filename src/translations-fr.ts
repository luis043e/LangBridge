...
welcome: {
  ...
  conversationsScreen: {
    ...
    emptyDescription:
      'Ouvrez une connexion et envoyez un message pour commencer.',
  },
  chatScreen: {
    defaultPartnerName:
      'Partenaire LangBridge',
  ...
  connectionsScreen: {
    ...
    title:
      'Mes connexions',
    subtitle:
      'Personnes avec qui vous pouvez pratiquer des langues.',
    loading:
...
requestsScreen: {
  ...
  editProfileScreen: {
    ...
    photoUnavailableMessage:
      "Ce compte n'a pas de photo Google disponible.",
    removePhotoTitle:
      'Supprimer la photo',
    removePhotoMessage:
